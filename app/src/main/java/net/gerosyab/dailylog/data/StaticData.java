...
//    public static final String CATEGORY_ORDER_INTENT_EXTRA = "Intent Extra for Category Order";
    ...
    public static final String RAW_TEXT_INTENT_EXTRA = "Intent Extra for Raw Text";
...
//    public static final long chartXAxisWeight = 10000000;

    public static final String[] RECORD_TYPE_NAME = {"Boolean", "Number", "Memo"};
